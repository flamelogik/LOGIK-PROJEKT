...
def create_after_effects_shot_script(shot_name, 
    ...
    shot_scripts_app_task_file = f"{shot_name}_{app_name}_{task_type}_{version_name}.jsx"
    ...
    with open(shot_scripts_app_task_path, 'w') as after_effects_shot_script_file:
        after_effects_shot_script_file.write(f"""# LOGIK-PROJEKT After Effects Shot Script
# Task Name: {shot_name}_{app_name}_{task_type}
Root {{
 inputs 0
 name "{shot_name}_{app_name}_{task_type}_{version_name}.jsx"
 frame AFTER_EFFECTS_START_FRAME
 first_frame AFTER_EFFECTS_START_FRAME
 last_frame AFTER_EFFECTS_END_FRAME
 lock_range true
...
Write {{
 ...
 first "AFTER_EFFECTS_START_FRAME"
 last "AFTER_EFFECTS_END_FRAME"
 use_limit true
 version 0
 ...
 postage_stamp true
        ...
        print(f"After Effects Shot script created:    {shot_name}_{app_name}_{task_type}.jsx\n")
