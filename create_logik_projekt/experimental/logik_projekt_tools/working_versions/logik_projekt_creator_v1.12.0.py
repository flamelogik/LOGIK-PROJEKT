...
class LogikProjektCreatorApp(QMainWindow):
    def __init__(self):
        ...
        self.connect_input_signals()  # Call the method to connect input signals
    ...
    def dynamic_summary(self, projekt_name, client_name, campaign_name, projekt_resolution, projekt_bit_depth, projekt_frame_rate, projekt_color_science, projekt_start_frame):
        ...
        self.summary_text.setText(summary)  # Update the text of the summary_text QTextEdit widget
        self.summary_text.repaint()  # Repaint the widget to reflect the changes

    def update_summary(self):
        """Update the summary text based on input field values."""
        base_path = self.base_path_input.text().strip()
        projekt_name = string_clean(self.projekt_name_input.text().strip())
        client_name = self.client_name_input.text().strip()
        campaign_name = self.campaign_name_input.text().strip()
