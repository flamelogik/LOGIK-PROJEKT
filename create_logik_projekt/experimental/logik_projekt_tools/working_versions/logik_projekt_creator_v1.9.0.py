...
from define_popup_menus import popup_menu_definitions  # Import popup menu definitions
...
class LogikProjektCreatorApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.projekt_resolution_input.addItems(popup_menu_definitions["Projekt Resolution"])
        ...
        self.projekt_bit_depth_input.addItems(popup_menu_definitions["Projekt Bit Depth"])
        ...
        self.projekt_frame_rate_input.addItems(popup_menu_definitions["Projekt Frame Rate"])
        ...
        self.projekt_color_science_input.addItems(popup_menu_definitions["Projekt Color Science"])
        ...
        self.projekt_start_frame_input.addItems(popup_menu_definitions["Projekt Start Frame"])
