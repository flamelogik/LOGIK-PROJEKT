...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Add buttons
        self.create_logik_projekt_button = self.create_button(layout, "Create LOGIK-PROJEKT", "darkgreen", self.create_logik_projekt)
        self.create_projekt_template_button = self.create_button(layout, "Create PROJEKT Template", "darkorange", self.create_projekt_template)
        self.cancel_button = self.create_button(layout, "Cancel", "darkred", self.cancel)
