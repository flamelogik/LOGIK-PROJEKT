...
from PySide6.QtWidgets import (
    ...
    QPushButton, QFrame, QLineEdit, QHBoxLayout)
...
class logik_projekt_main_window(QWidget):
    ...
    def create_labeled_entry(self, layout, label_text):
        ...
        label.setStyleSheet("color: white; font-family: 'Courier New';")
        layout.addWidget(label)
        line_edit = QLineEdit()
        line_edit.setStyleSheet("background-color: #111111; color: white; font-family: 'Courier New';")
