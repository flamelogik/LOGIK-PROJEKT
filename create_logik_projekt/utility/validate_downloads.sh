...
# Program Name:     validate_downloads.sh
# Version:          1.0
# Language:         bash script
# Flame Version:    2025.x
# Author:           Phil MAN - phil_man@mac.com
# Package:          MAN_MADE_MATERIAL
# Created:          2023-01-01
# Modified:         2024-02-07
...
# Description:      This program determines system information and validates
#                   the downloaded files against the md5 checksums.

# Installation:     Copy the script to your home directory,
