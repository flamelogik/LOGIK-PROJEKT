...
# ========================================================================== #
# This section defines old and new function names in an associative array.
# ========================================================================== #

# Declare an associative array
declare -A function_map

# Populate the associative array with old_function_name as key and new_function_name as value
function_map=(
...
for function_script in $function_scripts; do
    ...
    echo -e "# comments:              Replaced function names based on the defined mapping" >> "$function_script"
    
    echo -e "Processed $function_script"
    echo -e "\n$separator\n"
done
