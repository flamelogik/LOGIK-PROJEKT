# filename: create_blender_source_script.py

# -------------------------------------------------------------------------- #

# File Name:        create_blender_source_script.py
# Version:          2.1.2
...
#     """
#     Create a source script for blender based on layer and task.
...
#     # Append the Blender script content to the file
#     with open(source_scripts_app_task_path, 'a') as blender_source_script_file:
#         blender_source_script_file.write(f"""# LOGIK-PROJEKT Blender Source Script
...
#         # Write the Read node
#         blender_source_script_file.write(f"""
# Read {{
#  inputs 0
#  file_type exr
...
#         # logging.debug(f"Blender script created for:  {shot_source_dir}_{version_name}")

#         print(f"Blender Source script created:  {shot_source_dir}_{app_name}_{task_type}_{version_name}.nk\n")
...
#     with open(shot_scripts_app_task_path, 'a') as blender_shot_script_file:

#         # Write the Read node
#         blender_shot_script_file.write(f"""
# # Source Nodes
# Read {{
#  inputs 0
#  file_type exr
...
#         # # This section is for logging purposes
#         # logging.debug(f"Blender script appended for:  {shot_name}_{app_name}_{task_type}_{version_name}")

#         print(f"Read/Write nodes appended:   {shot_source_dir}_{app_name}_{task_type}\n")

def create_blender_source_script(job_root, shot_dir, seq_dir, seq_name, frame_rate, start_frame, end_frame, resolution):
    # Set render name
