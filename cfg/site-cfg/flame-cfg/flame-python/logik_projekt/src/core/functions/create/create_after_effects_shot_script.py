...
def create_after_effects_shot_script(shot_name,
    ...
    content = template_content.replace('@@SHOT_SCRIPTS_APP_TASK_SCRIPT@@', shot_scripts_app_task_script)
    content = content.replace('@@SHOT_SOURCES_DIR@@', shot_sources_dir)
    content = content.replace('@@SHOT_SOURCE_DIR@@', shot_source_dir)
    content = content.replace('@@SHOT_NAME@@', shot_name)
    ...
    content = content.replace('@@SHOT_SCRIPTS_APP_TASK_FILE_PATH@@', shot_scripts_app_task_file_path)
