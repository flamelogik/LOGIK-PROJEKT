...
```bash
python3 src/utils/common/create/create_ocio_config_json_file.py
```
...
```bash
python3 src/utils/common/create/create_ocio_conversion_tasks.py
```
...
```bash
python3 src/utils/common/create/create_ocio_flame_colortoolkit.py
```
