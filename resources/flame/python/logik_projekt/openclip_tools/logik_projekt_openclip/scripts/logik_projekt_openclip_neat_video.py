...
class class_projekt_openclip_neat_video():
    ...
    def media_panel_projekt_neat_video_clips(self):
        ...
        # Create batch group
        batch_group = flame.batch.create_batch_group('projekt_neat_video', reels=['sources','reference','CGI','mattes','depth','motion','multichannel','neat_video','paint','precomp','roto','comp'])
