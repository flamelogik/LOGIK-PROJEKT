...
SCRIPT_NAME = 'logik_projekt_openclip_precomp'
...
class class_projekt_openclip_precomp():
    ...
    def media_panel_projekt_precomp_clips(self):
        ...
        # Create batch group
        batch_group = flame.batch.create_batch_group('projekt_precomp', reels=['sources','reference','CGI','mattes','depth','motion','multichannel','neat_video','paint','precomp','roto','comp'])
