...
# Changelist:       Added platform-specific decryption and extraction scripts

# -------------------------------------------------------------------------- #

# Description:      This program will generate SSH keys, create an encrypted backup tar file,
#                   and generate platform-specific decryption and extraction scripts.
...
show_alert "Finished" "Script finished. Platform-specific decryption and extraction scripts have been created in $ssh_keys_folder."
